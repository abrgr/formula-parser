...
var LABEL_EXTRACT_REGEXP = /^(['][^']+['][!]|[A-Za-z_-][A-Za-z0-9_-]*[!])?([$])?([A-Za-z]+)([$])?([0-9]+)$/;
...
function extractLabel(label) {
  ...
  var _label$match = label.match(LABEL_EXTRACT_REGEXP),
      tabRef = _label$match[1],
      columnAbs = _label$match[2],
      column = _label$match[3],
      rowAbs = _label$match[4],
      row = _label$match[5];
 ...
 */
function toLabel(row, column, tab) {
...
var Parser = function (_Emitter) {
  ...
  Parser.prototype._callCellValue = function _callCellValue(label) {
    ...
    this.emit('callCellValue', { label: (0, _cell.toLabel)(row, column, tab), row: row, column: column, tab: tab }, function (_value) {
      value = _value;
    });
  ...
  Parser.prototype._callRangeValue = function _callRangeValue(startLabel, endLabel) {
    ...
    startCell.label = (0, _cell.toLabel)(startCell.row, startCell.column, tab);
    endCell.label = (0, _cell.toLabel)(endCell.row, endCell.column, tab);

    var value = [];

    this.emit('callRangeValue', startCell, endCell, tab, function () {
...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,6],$V1=[1,9],$V2=[1,7],$V3=[1,8],$V4=[1,10],$V5=[1,12],$V6=[1,13],$V7=[1,14],$V8=[1,15],$V9=[1,16],$Va=[1,17],$Vb=[1,19],$Vc=[1,20],$Vd=[1,21],$Ve=[1,22],$Vf=[1,23],$Vg=[1,24],$Vh=[1,25],$Vi=[1,26],$Vj=[1,27],$Vk=[1,28],$Vl=[5,10,11,12,14,15,16,17,18,19,20,21,29,30],$Vm=[5,10,11,12,14,15,16,17,18,19,20,21,29,30,32],$Vn=[5,10,11,12,14,15,16,17,18,19,20,21,29,30,34],$Vo=[5,11,12,14,15,16,17,18,29,30],$Vp=[5,11,14,15,16,17,29,30],$Vq=[5,11,12,14,15,16,17,18,19,20,29,30],$Vr=[14,29,30];
var parser = {trace: function trace() { },
yy: {},
symbols_: {"error":2,"expressions":3,"expression":4,"EOF":5,"cell":6,"variableSequence":7,"number":8,"STRING":9,"&":10,"=":11,"+":12,"(":13,")":14,"<":15,">":16,"NOT":17,"-":18,"*":19,"/":20,"^":21,"FUNCTION":22,"expseq":23,"ABSOLUTE_CELL":24,"RELATIVE_CELL":25,"MIXED_CELL":26,":":27,"ARRAY":28,";":29,",":30,"VARIABLE":31,"DECIMAL":32,"NUMBER":33,"%":34,"ERROR":35,"$accept":0,"$end":1},
terminals_: {5:"EOF",9:"STRING",10:"&",11:"=",12:"+",13:"(",14:")",15:"<",16:">",17:"NOT",18:"-",19:"*",20:"/",21:"^",22:"FUNCTION",24:"ABSOLUTE_CELL",25:"RELATIVE_CELL",26:"MIXED_CELL",27:":",28:"ARRAY",29:";",30:",",31:"VARIABLE",32:"DECIMAL",33:"NUMBER",34:"%",35:"ERROR"},
productions_: [0,[3,2],[4,1],[4,1],[4,1],[4,1],[4,3],[4,3],[4,3],[4,3],[4,4],[4,4],[4,4],[4,3],[4,3],[4,3],[4,3],[4,3],[4,3],[4,3],[4,2],[4,2],[4,3],[4,4],[4,1],[4,2],[6,1],[6,1],[6,1],[6,3],[6,3],[6,3],[6,3],[6,3],[6,3],[6,3],[6,3],[6,3],[23,1],[23,1],[23,3],[23,3],[7,1],[7,3],[8,1],[8,3],[8,2],[2,1]],
...
table: [{2:11,3:1,4:2,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{1:[3]},{5:[1,18],10:$Vb,11:$Vc,12:$Vd,15:$Ve,16:$Vf,17:$Vg,18:$Vh,19:$Vi,20:$Vj,21:$Vk},o($Vl,[2,2]),o($Vl,[2,3],{32:[1,29]}),o($Vl,[2,4],{34:[1,30]}),o($Vl,[2,5]),{2:11,4:31,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:32,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:33,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{13:[1,34]},o($Vl,[2,24],{2:35,35:$Va}),o($Vl,[2,26],{27:[1,36]}),o($Vl,[2,27],{27:[1,37]}),o($Vl,[2,28],{27:[1,38]}),o($Vm,[2,42]),o($Vn,[2,44],{32:[1,39]}),o([5,10,11,12,14,15,16,17,18,19,20,21,29,30,35],[2,47]),{1:[2,1]},{2:11,4:40,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:41,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:42,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:45,6:3,7:4,8:5,9:$V0,11:[1,43],12:$V1,13:$V2,16:[1,44],18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:47,6:3,7:4,8:5,9:$V0,11:[1,46],12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:48,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:49,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:50,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:51,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:52,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{31:[1,53]},o($Vn,[2,46]),{10:$Vb,11:$Vc,12:$Vd,14:[1,54],15:$Ve,16:$Vf,17:$Vg,18:$Vh,19:$Vi,20:$Vj,21:$Vk},o($Vo,[2,20],{10:$Vb,19:$Vi,20:$Vj,21:$Vk}),o($Vo,[2,21],{10:$Vb,19:$Vi,20:$Vj,21:$Vk}),{2:11,4:57,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,14:[1,55],18:$V3,22:$V4,23:56,24:$V5,25:$V6,26:$V7,28:[1,58],31:$V8,33:$V9,35:$Va},o($Vl,[2,25]),{24:[1,59],25:[1,60],26:[1,61]},{24:[1,62],25:[1,63],26:[1,64]},{24:[1,65],25:[1,66],26:[1,67]},{33:[1,68]},o($Vl,[2,6]),o([5,11,14,29,30],[2,7],{10:$Vb,12:$Vd,15:$Ve,16:$Vf,17:$Vg,18:$Vh,19:$Vi,20:$Vj,21:$Vk}),o($Vo,[2,8],{10:$Vb,19:$Vi,20:$Vj,21:$Vk}),{2:11,4:69,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:70,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},o($Vp,[2,15],{10:$Vb,12:$Vd,18:$Vh,19:$Vi,20:$Vj,21:$Vk}),{2:11,4:71,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},o($Vp,[2,14],{10:$Vb,12:$Vd,18:$Vh,19:$Vi,20:$Vj,21:$Vk}),o([5,11,14,17,29,30],[2,13],{10:$Vb,12:$Vd,15:$Ve,16:$Vf,18:$Vh,19:$Vi,20:$Vj,21:$Vk}),o($Vo,[2,16],{10:$Vb,19:$Vi,20:$Vj,21:$Vk}),o($Vq,[2,17],{10:$Vb,21:$Vk}),o($Vq,[2,18],{10:$Vb,21:$Vk}),o([5,11,12,14,15,16,17,18,19,20,21,29,30],[2,19],{10:$Vb}),o($Vm,[2,43]),o($Vl,[2,9]),o($Vl,[2,22]),{14:[1,72],29:[1,73],30:[1,74]},o($Vr,[2,38],{10:$Vb,11:$Vc,12:$Vd,15:$Ve,16:$Vf,17:$Vg,18:$Vh,19:$Vi,20:$Vj,21:$Vk}),o($Vr,[2,39]),o($Vl,[2,29]),o($Vl,[2,30]),o($Vl,[2,31]),o($Vl,[2,32]),o($Vl,[2,33]),o($Vl,[2,34]),o($Vl,[2,35]),o($Vl,[2,36]),o($Vl,[2,37]),o($Vn,[2,45]),o($Vp,[2,10],{10:$Vb,12:$Vd,18:$Vh,19:$Vi,20:$Vj,21:$Vk}),o($Vp,[2,12],{10:$Vb,12:$Vd,18:$Vh,19:$Vi,20:$Vj,21:$Vk}),o($Vp,[2,11],{10:$Vb,12:$Vd,18:$Vh,19:$Vi,20:$Vj,21:$Vk}),o($Vl,[2,23]),{2:11,4:75,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},{2:11,4:76,6:3,7:4,8:5,9:$V0,12:$V1,13:$V2,18:$V3,22:$V4,24:$V5,25:$V6,26:$V7,31:$V8,33:$V9,35:$Va},o($Vr,[2,40],{10:$Vb,11:$Vc,12:$Vd,15:$Ve,16:$Vf,17:$Vg,18:$Vh,19:$Vi,20:$Vj,21:$Vk}),o($Vr,[2,41],{10:$Vb,11:$Vc,12:$Vd,15:$Ve,16:$Vf,17:$Vg,18:$Vh,19:$Vi,20:$Vj,21:$Vk})],
...
rules: [/^(?:\s+)/,/^(?:[A-Za-z]{1,}[A-Za-z_0-9\.]+(?=[(]))/,/^(?:#[A-Z0-9\/]+(!|\?)?)/,/^(?:('[^']+'!|[A-Za-z_\-][A-Za-z0-9_\-]*!)?\$[A-Za-z]+\$[0-9]+)/,/^(?:('[^']+'!|[A-Za-z_\-][A-Za-z0-9_\-]*!)?\$[A-Za-z]+[0-9]+)/,/^(?:('[^']+'!|[A-Za-z_\-][A-Za-z0-9_\-]*!)?[A-Za-z]+\$[0-9]+)/,/^(?:('[^']+'!|[A-Za-z_\-][A-Za-z0-9_\-]*!)?[A-Za-z]+[0-9]+)/,/^(?:"(\\["]|[^"])*")/,/^(?:'(\\[']|[^'])*')/,/^(?:[A-Za-z\.]+(?=[(]))/,/^(?:[A-Za-z]{1,}[A-Za-z_0-9]+)/,/^(?:[A-Za-z_]+)/,/^(?:[0-9]+)/,/^(?:\[(.*)?\])/,/^(?:&)/,/^(?: )/,/^(?:[.])/,/^(?::)/,/^(?:;)/,/^(?:,)/,/^(?:\*)/,/^(?:\/)/,/^(?:-)/,/^(?:\+)/,/^(?:\^)/,/^(?:\()/,/^(?:\))/,/^(?:>)/,/^(?:<)/,/^(?:NOT\b)/,/^(?:")/,/^(?:')/,/^(?:!)/,/^(?:=)/,/^(?:%)/,/^(?:[#])/,/^(?:$)/],
